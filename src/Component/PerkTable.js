...
export const PERKS_BY_CLASS = {
  ...
  Spellweaver: [
...

    {
      ...
      boxes: [{ id: "spell-1-a" }, { id: "spell-1-b" }],
    },
    {
      label: "Add 2 {+1} cards",
      ops: [{ add: 3, times: 2 }],
      boxes: [{ id: "spell-2-a" }, { id: "spell-2-b" }],
    },
    {
      label: "Add 1 {+0 Stun} card",
      ops: [{ add: 36, times: 1 }],
      boxes: [{ id: "spell-3-a" }],
    },
    {
    ...
    {
      label: "Add 1 {+1 Immobilise} card",
      ops: [{ add: 28, times: 1 }],
      boxes: [{ id: "spell-5-a" }],
    },
    {
      label: "Add 1 {+1 Curse} card",
      ops: [{ add: 27, times: 1 }],
      boxes: [{ id: "spell-6-a" }],
    },
    {
      label: "Add 1 {+2 Fire} card",
      ops: [{ add: 30, times: 1 }],
      boxes: [{ id: "spell-7-a" }, { id: "spell-7-b" }],
    },
    {
      label: "Add 1 {+2 Ice} card",
      ops: [{ add: 31, times: 1 }],
      boxes: [{ id: "spell-8-a" }, { id: "spell-8-b" }],
    },
    {
      label: "Add 1 {Rolling Earth} aznd 1 {Rolling Air} card",
      ops: [
        { add: 34, times: 1 },
        { add: 32, times: 1 },
      ],
    ...
    {
      label: "Add 1 {Rolling Light} aznd 1 {Rolling Dark} card",
      ops: [
        { add: 35, times: 1 },
        { add: 33, times: 1 },
      ],
  ...
  Cragheart: [
...

    {
      ...
      boxes: [{ id: "crag-1-a" }, { id: "crag-1-b" }, { id: "crag-1-c" }],
    },
    {
      label: "Add 1 {-2} and 2 {+2} cards",
      ops: [
        { add: 4, times: 2 },
        { add: 6, times: 1 },
      ],
    ...
    },
    {
      label: "Add 1 {+1 Immobilise} card",
      ops: [{ add: 37, times: 1 }],
      boxes: [{ id: "crag-3-a" }, { id: "crag-3-b" }],
    },
    {
      label: "Add 1 {+2 Muddle} card",
      ops: [{ add: 38, times: 1 }],
      boxes: [{ id: "crag-4-a" }, { id: "crag-4-b" }],
    },
    {
      label: "Add 2 {Rolling Push 2} cards",
      ops: [{ add: 41, times: 2 }],
      boxes: [{ id: "crag-5-a" }],
    },
    {
      label: "Add 2 {Rolling Earth} card",
      ops: [{ add: 40, times: 2 }],
      boxes: [{ id: "crag-6-a" }, { id: "crag-6-b" }],
    },
    {
      label: "Add 2 {Rolling Air} card",
      ops: [{ add: 39, times: 2 }],
      boxes: [{ id: "crag-7-a" }],
    },
    {
      label: "Ignore negative Item effects (No effect on deck)",
      ops: [],
      boxes: [{ id: "crag-8-a" }],
    },
  ...
  Mindthief: [
    ...
    {
      label: "Replace 2 {+1} with 2 {+2} cards",
      ops: [
        { remove: 3, times: 2 },
        { add: 4, times: 2 },
      ],
    ...
    {
      label: "Replace 1 {-2} with 1 {+0} card",
      ops: [
        { remove: 6, times: 2 },
        { add: 0, times: 1 },
      ],
    ...
    },
    {
      label: "Add 1 {+2 Ice} card",
      ops: [{ add: 42, times: 1 }],
      boxes: [{ id: "mind-4-a" }, { id: "mind-4-b" }],
    },
    {
      label: "Add 2 {Rolling +1} cards",
      ops: [{ add: 46, times: 2 }],
      boxes: [{ id: "mind-5-a" }, { id: "mind-5-b" }],
    },
    {
      label: "Add 3 {Rolling Pull 1} cards",
      ops: [{ add: 47, times: 3 }],
      boxes: [{ id: "mind-6-a" }],
    },
    {
    ...
    {
      label: "Add 2 {Rolling Immobilise} card",
      ops: [{ add: 44, times: 2 }],
      boxes: [{ id: "mind-8-a" }],
    },
    {
      label: "Add 1 {Rolling Stun} card",
      ops: [{ add: 48, times: 1 }],
      boxes: [{ id: "mind-9-a" }],
    },
    {
      label: "Add 1 {Rolling Disarm} and 1 {Rolling Muddle} card",
      ops: [
        { add: 45, times: 1 },
        { add: 43, times: 1 },
      ],
